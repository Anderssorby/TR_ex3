...
plot(x,col=2,type="l",xlim=c(400,500),main="One step predictions",ylab=TeX("X_t,\\hat{X}_t"),xlab="Time")
lines(xhat,col=4)
```
<!--
# ```{r one step predictions}
# xhat<- (x - arima$residuals) #mangler muligens en faktor sqrt(r(phi,theta))
