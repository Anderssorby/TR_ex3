...
```{r residualacf, echo=FALSE, fig.cap="The autocorrelation of the residuals\\label{fig:residualacf}"}
...
On the basis of the residuals' sample autocorrelation, plotted in figure \ref{figresidualacf}, we may not reject the hypothesis that the residuals are independently distributed. 
