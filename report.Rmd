...
From equation \eqref{eq:pi} we then get the one-step ahead predictor of our model
...
plot(x,col=2,type="l",xlim=c(400,500),main="One-step ahead predictions",ylab=TeX("X_t,\\hat{X}_t"),xlab="Time")
lines(xhat,col=4)
lines(Z,col=3)
```
<!--
